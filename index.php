...
<!-- <div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">admin@admin.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 11223344</li>	
					<!-- <li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">Mantis <span>Mind</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
...
<div class="col-md-12 book-form-left-w3layouts">
	<a href="admin/reservation.php"><h2>ROOM RESERVATION <p> (click here) </p> </h2></a>
</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">Mantis Mind</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<!-- <div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our Mantis Mind</h3> 
						   <p class="about-para-w3ls">The hotel Mantis Mind is one of the best in the city.The hotel is having its own standards.for more information you can go through our broucher.</p>
			 ...
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			    <div class="advantage-block">
					<i class="fa fa-clock-o" aria-hidden="true"></i>
			 		...
			 		<p>its like a postpaid offer becuase you can pay the bill when you are closing the room</p>
			 ...
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					<i class="fa fa-clock-o" aria-hidden="true"></i>
			 		...
			 		<p>you can come to our hotel at any time .there is no restriction for time</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<!-- <div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">admin@admin.COM</a></p>
